...
const messages = {
  'zh-CN': {
    ...
    settings: {
      ...
      pollInterval: '轮询间隔（秒）',
      tickRetention: '行情明细保存天数',
      tickRetentionHint: '保存最近 3-30 天的行情明细，较早内容会自动整理。',
      alertRetention: '告警历史保留（天）',
      alertRetentionHint: '保存最近 30-365 天的告警记录，较早内容会自动整理。',
      quietStart: '静音开始',
      quietEnd: '静音结束',
      soundProfile: '提示音',
      applySound: '应用提示音',
      ...
      storageTitle: '存储空间与数据保存',
      storageHint: '查看本地占用、释放空间、保存数据，并在需要时生成排查文件。',
      storageCoreData: '保存的数据',
      storageDataRoot: '保存位置',
      storageMainDb: '数据文件',
      storagePriceTicks: '行情明细',
      storageAlertEvents: '告警记录',
      storageLatestTick: '最新行情',
      storageLatestAlert: '最新告警',
      storageLastActivity: '最后活动',
      storageSessionData: '会话缓存',
      storageArchiveDir: '长期记录位置',
      storageBackupDir: '备份保存位置',
      storageLatestBackup: '最近备份',
      storageLatestMainBackup: '最近一次数据备份',
      storageLogsDir: '日志目录',
      storageMissing: '未创建',
      ...
      storageLocation: '查看保存位置',
      storageTotalUsage: '总占用',
      storageDatabaseUsage: '数据库占用',
      storageCleanableCache: '可清理缓存',
      storageBackupUsage: '备份占用',
      storageRecentBackup: '最近备份',
      storageRecentBackupEmpty: '还没有备份',
      storageCanClear: '可释放空间',
      storageCanClearHint: '只会清理临时内容，不会删除已保存的数据、长期记录和手动备份。',
      storageBackupProtection: '备份保护',
      storageProtectedData: '会保留的数据',
      storageProtectedDataHint: '已保存的数据、长期记录和你手动创建的备份都会保留。',
      storageAutoMaintenance: '自动节省空间',
      storageAutoMaintenanceSummary: (tickDays: number, alertDays: number) =>
        `系统会自动保存最近 ${tickDays} 天行情明细、${alertDays} 天告警记录。`,
      storageAutoMaintenanceHint:
        '应用会在后台整理较早记录，手动释放空间不会删除核心监控记录。',
      storageTechnicalDetails: '排查信息（高级）',
      storageTechnicalDetailsHint: '需要定位问题时再展开，这里包含实际保存位置和记录数量。',
      storageDetailMainDbPath: '数据文件位置',
      storageDetailArchiveDir: '长期记录位置',
      storageDetailBackupDir: '备份保存位置',
      storageDetailSessionDir: '临时数据位置',
      storageDetailLogsDir: '日志位置',
      storageDetailLastActivity: '最近活动',
      storageDetailLastCleanup: '最近清理',
      storageDetailMarketHistory: '行情明细记录',
      storageDetailAlertHistory: '告警记录',
      storageDetailCountSuffix: '条',
      storageClearCache: '释放空间',
      storageClearCacheBusy: '正在释放空间...',
      storageClearCacheEmpty: '当前没有可清理内容。',
      storageClearCacheDone: (sizeText: string) => `已释放约 ${sizeText}。`,
      storageClearCacheFailed: '释放空间失败，请稍后重试。',
      runtimeControl: '运行控制',
  ...
  'en-US': {
    ...
    settings: {
      ...
      tickRetention: 'Market detail retention (days)',
      tickRetentionHint: 'Save the latest 3-30 days of market details. Older content is organized automatically.',
      alertRetention: 'Alert History Retention (days)',
      alertRetentionHint: 'Save the latest 30-365 days of alert history. Older content is organized automatically.',
      ...
      storageTitle: 'Storage Space & Saved Data',
      storageHint: 'Review local usage, free space, save a data copy, and create a troubleshooting file when needed.',
      storageCoreData: 'Saved data',
      storageDataRoot: 'Save location',
      storageMainDb: 'Data file',
      storagePriceTicks: 'Market details',
      storageAlertEvents: 'Alert records',
      storageLatestTick: 'Latest Market Update',
      storageLatestAlert: 'Latest Alert',
      storageLastActivity: 'Last Activity',
      storageSessionData: 'Session Cache',
      storageArchiveDir: 'Long-term records location',
      storageBackupDir: 'Backup location',
      storageLatestBackup: 'Latest Backup',
      storageLatestMainBackup: 'Latest Data Backup',
      storageLogsDir: 'Logs Dir',
      ...
      storageLocation: 'View save location',
      storageTotalUsage: 'Total usage',
      storageDatabaseUsage: 'Database',
      storageCleanableCache: 'Cleanable cache',
      storageBackupUsage: 'Backups',
      storageRecentBackup: 'Recent backup',
      storageRecentBackupEmpty: 'No backup yet',
      storageCanClear: 'Space available to free',
      storageCanClearHint:
        'Only temporary content is removed. Saved data, long-term records, and manual backups stay untouched.',
      storageBackupProtection: 'Backup protection',
      storageProtectedData: 'Data that stays saved',
      storageProtectedDataHint:
        'Saved data, long-term records, and your manual backups are always preserved.',
      storageAutoMaintenance: 'Automatic space saving',
      storageAutoMaintenanceSummary: (tickDays: number, alertDays: number) =>
        `The app automatically saves ${tickDays} days of market details and ${alertDays} days of alert history.`,
      storageAutoMaintenanceHint:
        'Background organization handles older records, and freeing space does not delete core monitoring records.',
      storageTechnicalDetails: 'Troubleshooting info (advanced)',
      storageTechnicalDetailsHint:
        'Expand only when you need to locate an issue. This includes actual save locations and record counts.',
      storageDetailMainDbPath: 'Data file location',
      storageDetailArchiveDir: 'Long-term records location',
      storageDetailBackupDir: 'Backup location',
      storageDetailSessionDir: 'Temporary data location',
      storageDetailLogsDir: 'Logs location',
      storageDetailLastActivity: 'Last activity',
      storageDetailLastCleanup: 'Last cleanup',
      storageDetailMarketHistory: 'Market detail records',
      storageDetailAlertHistory: 'Alert history',
      storageDetailCountSuffix: 'records',
      storageClearCache: 'Free Space',
      storageClearCacheBusy: 'Freeing space...',
      storageClearCacheEmpty: 'There is nothing to clean right now.',
      storageClearCacheDone: (sizeText: string) => `About ${sizeText} was freed.`,
      storageClearCacheFailed: 'Failed to free space. Please retry.',
